                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class = "md-4 text-center">
                        @if($product->shop->filename !== null)
                         ...
                         {{--rounded-full = 画像を丸くする object-cover = 元の比率を持ったまま表示--}}
                        @else
                            <img src="">
                        @endif
                    </div>
                    <div class = "md-4 text-center">
                        <button data-micromodal-trigger="modal-1" htef='javascript:;' class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">ショップの詳細を見る</button>
                    </div>
                </div>
            </div>
        </div>
